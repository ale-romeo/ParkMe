...
$update_slots = "UPDATE Parking_Space JOIN Parking_Payment ON Parking_Space.id = Parking_payment.park_id SET Parking_Space.STATUS = 'Available', Parking_Space.parking_ending_time = NULL, Parking_Payment.status = 0 WHERE Parking_Space.STATUS = 'Occupied' AND Parking_Space.parking_ending_time < '$time' AND Parking_Payment.status = 1";
